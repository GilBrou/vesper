    ...
    <section id="à-propos" className="about">
      <div className="subTAbout subAboutDown">
        ...
        <p>
          ...
          n’en faisais rien ou que je la canalisais à travers mes livres
          seulement, elle a un jour décidé que c’était trop. Elle s’est insurgée
          contre ma peur, contre ma fierté, mon manque de confiance en soi. Le
          soir précédant l’enterrement de ma grand-mère, précisément. Je logeais
          dans son appartement et tentais de m’endormir, ce que j’avais beaucoup
          de mal à faire étant donné l’émotion et la nervosité qui me
          submergeait au fil des heures. Arrivé trois heures et quelque du
          matin, un poing frappa à deux reprises sur le piano qui faisait face à
          mon lit. J’ai sursauté, je suis restée assise à attendre, écouter.
          Puis je me suis sentie plus légère, parce que je sentais que ma
          grand-mère me faisait signe, m’envoyait un encouragement, une
          exhortation à être plus forte, tout comme elle l’était de son vivant.
          Je n’ai pas eu peur. En fait, avec le recul, c’était même évident.
          Tout comme je n’avais pas eu peur lorsque j’étais entrée dans sa
          chambre quelques heures plus tôt et avait physiquement ressenti sa
        ...
        <p>
          ...
          elle aussi s’est approfondie à cette période critique de ma vie.
          Décrypter mon thème astral a confirmé tout ce vécu que j’avais
          traversé, ces épreuves très spécifiques et ces inclinations précises
          dans mon caractère, ma sensibilité : tout ce que je pressentais comme
          juste concernant la direction spirituelle que je prenais dans ma vie
          et dans laquelle je me sentais, étrangement, comme « chez moi ».
          Sentiment qui ne fait que se confirmer depuis que j’ai choisi de
          suivre cette voie, et qui fait que vous me lisez maintenant. J’ai
          saisi vers quel but tendre, grâce à cet outil fabuleux qu’est
          l’astrologie, et à la voix des cartes qui m’a fortifiée intimement.
